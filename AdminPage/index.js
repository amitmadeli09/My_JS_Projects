...
form.addEventListener("submit", (event) => {
    ...
    axios
        .post("https://crudcrud.com/api/bb405d2eb4fc466bb406e88260c2cc82/productDetails", productDetails)
        .then((response) => {
...
function displayOnScreen(productDetails) {
    ...
    delete_btn.addEventListener("click", () => {
        axios
            .delete(`https://crudcrud.com/api/bb405d2eb4fc466bb406e88260c2cc82/productDetails/${productDetails._id}`)
            .then(() => {
                UL.removeChild(list);
                totalValue -= parseFloat(productDetails.price);
                totalPrice(totalValue);
...
window.addEventListener("DOMContentLoaded", () => {
    axios
        .get("https://crudcrud.com/api/bb405d2eb4fc466bb406e88260c2cc82/productDetails")
        .then((response) => {
